...
#if 0 // FATFS_USE_WRITEPROTECT_PIN > 0
 ...
 */
//#define SDIO_TRANSFER_CLK_DIV         ((uint8_t)0x0)	//24Mhz
//#define SDIO_TRANSFER_CLK_DIV         ((uint8_t)0x2)	//12Mhz
#define SDIO_TRANSFER_CLK_DIV         ((uint8_t)0x4)	//8Mhz
