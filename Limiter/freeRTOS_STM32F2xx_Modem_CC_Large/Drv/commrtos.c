...
INT8U		 tx_stat[MAXCOMM_CH] = {0};

COMM_RING_BUF CommBuf[MAXCOMM_CH];

USART_TypeDef *pUART_BASE[2] = {USART1,USART2};
...
void __sub_Can_RxInt(INT8U ch, INT8U data)
{
	CommPutRxChar(ch, data);
}
...
void modemPutCharStr(INT8U *pdata, INT32U SendCount)
{
	int i;
