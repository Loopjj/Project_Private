...
* Return         : None
*******************************************************************************/
void SPI_FLASH_SectorErase(INT32U SectorAddr)
{
	...
	if(xSemaphoreTake(SpiFlashDevSem, ( portTickType ) 50 )  == pdTRUE)
	{
...
* Return         : None
*******************************************************************************/
void SPI_FLASH_PageErase(INT32U PageAddr)
{
	if(SpiFlashDevSem == NULL)
	{
		printk("%s err\n",__func__);
...
* Return         : None
*******************************************************************************/
void SPI_FLASH_BlockErase(INT32U BlockAddr)
{
	if(SpiFlashDevSem == NULL)
	{
		printk("%s err\n",__func__);
...
* Return         : None
*******************************************************************************/
void SPI_FLASH_PageWrite(INT8U* pBuffer, INT32U WriteAddr, INT16U NumByteToWrite)
{
...
* Return         : None
*******************************************************************************/
INT8U SPI_FLASH_BufferWrite(INT8U* pBuffer, INT32U WriteAddr, INT32U NumByteToWrite)
{
...
* Return         : None
*******************************************************************************/
void SPI_FLASH_BufferRead(INT8U* pBuffer, INT32U ReadAddr, INT32U NumByteToRead)
{
	//INT8U err;
	if(SpiFlashDevSem == NULL)
	{
...
* Return         : None
*******************************************************************************/
void SPI_FLASH_StartReadSequence(INT32U ReadAddr)
{
	//INT8U err;
...
*******************************************************************************/
u8 SPI_FLASH_SendByte(INT8U byte)
{
...
*******************************************************************************/
u16 SPI_FLASH_SendHalfWord(INT16U HalfWord)
{
  /* Loop while DR register in not emplty */
  while (SPI_I2S_GetFlagStatus(SPI_FLASH_DEV, SPI_I2S_FLAG_TXE) == RESET);
