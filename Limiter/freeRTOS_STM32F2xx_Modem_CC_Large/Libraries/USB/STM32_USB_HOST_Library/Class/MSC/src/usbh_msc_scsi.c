...
/**
  ...
  * @retval Status
  */
uint8_t USBH_MSC_Inquiry (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  {  
    ...
    case CMD_SEND_STATE:
      ...
      USBH_MSC_BOTXferParam.MSCStateCurrent = USBH_MSC_INQUIRY;
      ...
      USBH_MSC_CBWData.field.CBWCB[4]  = 0x24;
  ...
  {  
   switch(USBH_MSC_BOTXferParam.CmdStateMachine)
    ...
    case CMD_SEND_STATE:
      ...
      /*Prepare the CBW and relevent field*/
      USBH_MSC_CBWData.field.CBWTransferLength = \
                                                DATA_LEN_REQUEST_SENSE; //ALLOCATION_LENGTH_REQUEST_SENSE;
      USBH_MSC_CBWData.field.CBWFlags = USB_EP_DIR_IN;
      USBH_MSC_CBWData.field.CBWLength = CBW_LENGTH;
      ...
      USBH_MSC_CBWData.field.CBWCB[1]  = DESC_REQUEST_SENSE;
      USBH_MSC_CBWData.field.CBWCB[4]  = DATA_LEN_REQUEST_SENSE; //ALLOCATION_LENGTH_REQUEST_SENSE;
