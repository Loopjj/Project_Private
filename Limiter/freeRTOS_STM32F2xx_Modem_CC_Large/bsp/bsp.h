...
#define REGEN_LED(val)		GPIO_WriteBit(GPIOE,  GPIO_Pin_13, val ? Bit_RESET : Bit_SET)
#define CHECK_LED(val)	  GPIO_WriteBit(GPIOE,  GPIO_Pin_14, val ? Bit_RESET : Bit_SET)
#define PRESS_LED(val)	  GPIO_WriteBit(GPIOE,  GPIO_Pin_15, val ? Bit_RESET : Bit_SET)
...
//#define KeyOn_Check()     { if(POWER_SIG()) Sts.KeyOn = 0; else Sts.KeyOn = 1;}
#define KeyOn_Check()     { if(POWER_SIG()) ReadValue.Sig.KeyOn = 1; else ReadValue.Sig.KeyOn = 0;}
