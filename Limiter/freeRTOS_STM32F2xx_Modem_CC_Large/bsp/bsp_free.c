...
static void BSP_CAN1_Init(void)
{
  ...
  GPIO_PinAFConfig(GPIOB, GPIO_PinSource9, GPIO_AF_CAN1); //Connect CAN1 TX pin to alternate function
	...
	CAN_InitStructure.CAN_BS1=CAN_BS1_6tq;      // Samplepoint 72%
	CAN_InitStructure.CAN_BS2=CAN_BS2_8tq;      // Samplepoint 72%
...
//  CAN_FilterInitStructure.CAN_FilterIdHigh		  = (u16)(0x0000<<5);
//  CAN_FilterInitStructure.CAN_FilterIdLow			  = (u16) 0x0000;
//  CAN_FilterInitStructure.CAN_FilterMaskIdHigh	= (u16)(0x0000<<5);
//  CAN_FilterInitStructure.CAN_FilterMaskIdLow		= (u16) 0x0000;
//	CAN_FilterInit(&CAN_FilterInitStructure);
#else
//  CAN_FilterInitStructure.CAN_FilterNumber        = 0;						
//  CAN_FilterInitStructure.CAN_FilterIdHigh		    = (u16)(0x0010<<5);  // 0x010 ~ 0x013 수신
//  CAN_FilterInitStructure.CAN_FilterIdLow			    = (u16)0x0000;//(0x0098<<5);  // 0x098 ~ 0x099 수신
//  CAN_FilterInitStructure.CAN_FilterMaskIdHigh	  = (u16)(0x07FC<<5);
//  CAN_FilterInitStructure.CAN_FilterMaskIdLow		  = (u16)0x0000;//(0x07FE<<5);
//	CAN_FilterInit(&CAN_FilterInitStructure);
//  
//	CAN_FilterInitStructure.CAN_FilterNumber        = 1;						
//  CAN_FilterInitStructure.CAN_FilterIdHigh		    = (u16)(0x0100<<5);  // x100 ~ 0x1FF 수신
//  CAN_FilterInitStructure.CAN_FilterIdLow			    = (u16)0x0000;//(0x0030<<5);
//  CAN_FilterInitStructure.CAN_FilterMaskIdHigh	  = (u16)(0x0700<<5);
//  CAN_FilterInitStructure.CAN_FilterMaskIdLow		  = (u16)0x0000;//(0x07C8<<5);
//	CAN_FilterInit(&CAN_FilterInitStructure);
  
  CAN_FilterInitStructure.CAN_FilterNumber        = 0;						
  CAN_FilterInitStructure.CAN_FilterIdHigh		    = (u16)(0x0010<<5);  // 0x010 ~ 0x013 수신
  CAN_FilterInitStructure.CAN_FilterIdLow			    = (u16)0x0000;  // 0x098 ~ 0x099 수신
  CAN_FilterInitStructure.CAN_FilterMaskIdHigh	  = (u16)(0x07FC<<5);
  CAN_FilterInitStructure.CAN_FilterMaskIdLow		  = (u16)0x0000;
	CAN_FilterInit(&CAN_FilterInitStructure);
  
	CAN_FilterInitStructure.CAN_FilterNumber        = 1;						
  CAN_FilterInitStructure.CAN_FilterIdHigh		    = (u16)(0x0098<<5);  // x100 ~ 0x1FF 수신
  CAN_FilterInitStructure.CAN_FilterIdLow			    = (u16)0x0000;
  CAN_FilterInitStructure.CAN_FilterMaskIdHigh	  = (u16)(0x007FE<<5);
  CAN_FilterInitStructure.CAN_FilterMaskIdLow		  = (u16)0x0000;
  
  CAN_FilterInitStructure.CAN_FilterNumber        = 2;						
  CAN_FilterInitStructure.CAN_FilterIdHigh		    = (u16)(0x0100<<5);  // 0x010 ~ 0x013 수신
  CAN_FilterInitStructure.CAN_FilterIdLow			    = (u16)0x0000;  // 0x098 ~ 0x099 수신
  CAN_FilterInitStructure.CAN_FilterMaskIdHigh	  = (u16)(0x0700<<5);
  CAN_FilterInitStructure.CAN_FilterMaskIdLow		  = (u16)0x0000;
	CAN_FilterInit(&CAN_FilterInitStructure);
  ...
  CAN_FilterInitStructure.CAN_FilterIdHigh		    = (u16)(0x0030<<5);  // x100 ~ 0x1FF 수신
  CAN_FilterInitStructure.CAN_FilterIdLow			    = (u16)0x0000;
  CAN_FilterInitStructure.CAN_FilterMaskIdHigh	  = (u16)(0x07C8<<5);
  CAN_FilterInitStructure.CAN_FilterMaskIdLow		  = (u16)0x0000;
	CAN_FilterInit(&CAN_FilterInitStructure);
  
	CAN_FilterInitStructure.CAN_FilterNumber        = 4;						
  CAN_FilterInitStructure.CAN_FilterIdHigh		    = (u16)((0x14FF0055<<3)>>16);
  CAN_FilterInitStructure.CAN_FilterIdLow			    = (u16)((0x14FF0055<<3) | 4);
  CAN_FilterInitStructure.CAN_FilterMaskIdHigh	  = (u16)((0xFFFFFFFF<<3)>>16);
  CAN_FilterInitStructure.CAN_FilterMaskIdLow		  = (u16)((0xFFFFFFFF<<3) | 4);
	CAN_FilterInit(&CAN_FilterInitStructure);
  
	CAN_FilterInitStructure.CAN_FilterNumber        = 5;						
  CAN_FilterInitStructure.CAN_FilterIdHigh		    = (u16)(0x700<<5);     // x100 ~ 0x1FF ????
  CAN_FilterInitStructure.CAN_FilterIdLow			    = (u16)0x0000;
  CAN_FilterInitStructure.CAN_FilterMaskIdHigh	  = (u16)(0x900<<5);
  CAN_FilterInitStructure.CAN_FilterMaskIdLow		  = (u16)0x0000;
	CAN_FilterInit(&CAN_FilterInitStructure);    
#endif  
	//GPIO_WriteBit(GPIOE, GPIO_Pin_5, Bit_RESET );	// CAN1 OBD STBY HIGH //Bit_RESET
