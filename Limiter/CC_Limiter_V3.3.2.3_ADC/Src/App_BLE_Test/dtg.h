...
#define CAN_KEY_OFF_WAIT_LIMIT       5       // 5 sec
...
DTG_EXT stVal Val;
#ifdef EVENT_DATA_SAVE_ENABLE
DTG_EXT tsSecData Save_SecData_Buff[10]; // nand 1sec * 10  
#endif
...
DTG_EXT stIsgSetting IsgSetting, TmpIsgSetting;
...
DTG_EXT u8 DpfFlag, VehMaintenanceFlag;

DTG_EXT u32 Key_Off_Time;
DTG_EXT u8 TakeSendFlag;
...
#ifdef EVENT_DATA_SAVE_ENABLE
DTG_EXT void Event_Data_Update(void);
#endif
#endif